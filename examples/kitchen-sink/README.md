...
| Route               | Surface                                                                                                                                                                                                                                                                                                                                                                                                                         |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/`                 | static route; `href()` to every route; branded `Href` into `<Link>`; the nav's exotic-wing tabs use the static string form — `href("/about")`, registry-verified, no route object (SH1)                                                                                                                                                                                                                                         |
...
| `/products/[id]`    | single `[id]` (Zod-refined `p.integer`); search covering `p.string`(+schema)/`p.number`/`p.boolean`/`p.enum`/`p.integer`/`p.array` with `.optional()`, value `.default()` (+ D8 elision), and `.default().catch()`; server `parse` + `parseParams`; safe client hooks (`useRouteParams`/`useSearch`)                                                                                                                            |
