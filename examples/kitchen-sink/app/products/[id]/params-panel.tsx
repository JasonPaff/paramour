...
// Client-side twin of the server parse in page.tsx. The SAFE hooks are a
// useMemo over Next's useParams()/useSearchParams(): no loading state, and a
// malformed URL surfaces as the `status: "error"` arm rather than throwing —
// the component renders a fallback instead of crashing the tree.
