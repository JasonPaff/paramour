...
/**
 * The seam contract is STRUCTURAL, so tests hand-build the data-only slot
 * and assign it to the well-known global key — no seam-write export needed,
 * and the fabrication doubles as a contract check: if the panel stops
 * reading this shape, every test here breaks.
 */
