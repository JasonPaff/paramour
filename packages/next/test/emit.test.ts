...
`;
  ...
  it("omits pagesRoutes for an app-only project (absent, not never)", () => {
  ...
  it("omits appRoutes for a pages-only project (absent, not never)", () => {
  ...
  it("sorts by code unit, not locale ('/Z' < '/a' < '/é')", () => {
    ...
    // this pin feeds the byte-identical-on-every-OS guarantee.
